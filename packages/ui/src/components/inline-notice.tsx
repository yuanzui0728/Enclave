...
const inlineNoticeVariants = cva("rounded-[var(--radius-md)] border px-4 py-3 text-sm leading-6", {
  variants: {
    tone: {
      muted: "border-[color:var(--border-subtle)] bg-[color:var(--surface-secondary)] text-[color:var(--text-secondary)]",
