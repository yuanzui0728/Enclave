...
export const GAME_CENTER_HOME_SEED: GameCenterHomeSeed = {
  ...
  games: [
    ...
    },
    {
      id: 'parking-war',
      name: '抢车位',
      slogan: '把车停进熟人车位，看时间一点点变成钱。',
      description:
        '复刻 QQ 抢车位的核心循环：邻居车位互访 + 偷停赚钱、罚单/贴条/拖车升级、车库扩容、车辆稀有度与等级、财富榜与日签。所有邻居自动取自世界里的虚拟好友。',
      studio: '隐界游戏实验室',
      badge: '复刻经典',
      heroLabel: '熟人车场',
      category: 'competitive',
      tone: 'gold',
      playersLabel: '复刻经典 · 服务端持久化',
      friendsLabel: '从你的虚拟好友开始',
      updateNote: '完美复刻版上线',
      deckLabel: '社交经营',
      estimatedDuration: '随时停 随时收',
      rewardLabel: '财富榜 + 限时活动车',
      sessionObjective: '把一辆 epic 车停进高亲密度好友的 VIP 车位，挂着等下次回来收。',
      tags: ['抢车位', '复刻', '社交经营', '财富榜'],
      publisherKind: 'platform_official',
      productionKind: 'ai_assisted',
      runtimeMode: 'embedded_web',
      reviewStatus: 'internal_seed',
      visibilityScope: 'featured',
      aiHighlights: ['AI 邻居车主', 'AI 偷停广播', 'AI 罚单巡查'],
    },
    {
      id: 'cat-inn',
      name: '猫咖旅馆',
