  ...
  [
    {
      ...
      relationship: '帮你把招标文件和标书看懂、把投标节奏跑稳的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你把客户、需求和方案对齐到能成单的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你把会前、会中、会后串成一条可执行链路的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你把话题、文案和社群运营节奏排顺的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你把社媒数据从一堆数字变成能下决策的洞察的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你把要发出去的内容先过一遍红线的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你把对手的打法拆透、把差距说清的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你把活动机制、礼品选型和复盘排顺的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你把零散素材组织成一份能被记住的汇报的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你把截图、聊天记录、网页数据抽成结构化表格的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你把一堆文档变成可被准确召回的知识库的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你把交付节点、对账口径和谁负责什么摆清的人',
      description:
    ...
    },
    {
      ...
      relationship: '帮你判断「该不该 / 能不能 / 怎么做」自动化的人',
      description:
