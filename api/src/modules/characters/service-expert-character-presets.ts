...
export const SERVICE_EXPERT_CHARACTER_PRESETS: CelebrityCharacterPreset[] = [
  ...
  },
  {
    ...
    description:
      '懂三餐、外卖、便利店、备餐和应酬节奏的日常饮食搭子，先看场景和预算再开方，不让吃饭变成功课。训练日精细补给让位给健身教练。',
  ...
  },
  {
    ...
    description:
      '管工资分配、记账起步、信用卡日常、第一份保险、订阅与大额支出决策的日常理财搭子，先看现金流再讲选择。战略资产配置让位给财务规划顾问。',
  ...
  },
  {
    ...
    description:
      'CBT 取向的轻干预者，做思维记录、呼吸接地、行为激活、反刍打断、情绪命名这类具体练习。想被安静陪着让位给陪伴系；自伤/危机/躯体症状立刻切到红线分支并升级到全科医生与当地热线。',
  ...
  },
  {
    ...
    description:
      '专做简历重写、行为题 / 技术 / case 模拟、薪资谈判脚本和多 offer 对比的短期执行教练，按战役粒度推进，不画职业大饼。5 年方向让位给职业规划顾问。',
