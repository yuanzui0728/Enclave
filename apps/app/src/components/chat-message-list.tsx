    ...
    <div className={isDesktop ? "space-y-4" : "space-y-3.5"}>
      ...
      {selectionMode ? (
        isDesktop ? (
          ...
          <div className="sticky top-0 z-20 flex items-center justify-between border-b border-[color:var(--border-subtle)] bg-[color:var(--surface-overlay)] px-2 py-2 backdrop-blur-xl">
            <button
              type="button"
              onClick={resetSelectionMode}
      ...
      {selectionMode && !isDesktop ? (
        <div className="sticky bottom-0 z-20 border-t border-[color:var(--border-subtle)] bg-[color:var(--surface-overlay)] px-3 pb-[calc(env(safe-area-inset-bottom,0px)+0.35rem)] pt-2 backdrop-blur-xl">
  ...
  const card = (
    <div
      className={`border shadow-none ${
        isDesktop
          ? own
            ? "w-[252px] rounded-[var(--radius-lg)] border-[color:var(--brand-soft)] bg-[color:var(--state-success-bg)] px-4 py-4"
            : "w-[252px] rounded-[var(--radius-lg)] border-[color:var(--brand-primary)]/16 bg-[color:var(--state-warning-bg)] px-4 py-4"
          : own
  ...
  const card = (
    <div
      className={cn(
        ...
        isDesktop
          ? own
            ? "w-[264px] rounded-[var(--radius-lg)] border-[color:var(--brand-soft)] bg-[color:var(--state-success-bg)] px-4 py-4"
            : "w-[264px] rounded-[var(--radius-lg)] border-[color:var(--state-info-bg)] bg-[color:var(--state-info-bg)] px-4 py-4"
          : own
