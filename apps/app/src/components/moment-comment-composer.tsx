  ...
  return (
    <div className={cn("flex min-w-0 flex-1 items-end gap-2", className)}>
      <textarea
        ...
        autoComplete="off"
        className={cn(
          "min-h-9 max-h-24 min-w-0 flex-1 resize-none rounded-[20px] border border-[color:var(--border-faint)] bg-white px-3 py-2 text-[16px] leading-5 text-[color:var(--text-primary)] shadow-[inset_0_1px_0_rgba(255,255,255,0.72)] outline-none transition-[border-color,background-color,box-shadow] placeholder:text-[color:var(--text-dim)] focus:border-[color:var(--border-brand)] focus:shadow-[var(--shadow-focus)]",
          inputClassName,
        )}
      />
      <Button
