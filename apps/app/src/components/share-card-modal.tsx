      ...
      <div className="relative flex w-full max-w-md flex-col overflow-hidden rounded-2xl bg-[color:var(--surface-card)] shadow-2xl">
        ...
        <div className="border-t border-[color:var(--border-faint)] px-4 py-3">
          ...
          <button
            ...
            className="w-full rounded-[16px] bg-[color:var(--brand-primary)] py-3 text-[15px] font-medium text-[color:var(--text-on-brand)] active:bg-[color:var(--brand-primary)] disabled:cursor-not-allowed disabled:bg-gray-300"
          >
