...
export function MobileChatScrollBottomButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex h-9 items-center gap-1.5 rounded-full border border-[color:var(--border-subtle)] bg-[color:var(--surface-card)]/96 px-3 pl-2.5 text-[length:var(--text-caption)] text-[color:var(--text-primary)] shadow-[0_8px_18px_rgba(60, 40, 110, 0.12)] backdrop-blur active:bg-[color:var(--surface-card-hover)]"
      aria-label={
        hasPending
    ...
    >
      ...
      <span className={hasPending ? "text-[color:var(--brand-primary)]" : undefined}>
