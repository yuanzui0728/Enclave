        ...
        >
          ...
          >
            ...
            <input
              ...
              className={cn(
                "w-full rounded-[10px] border border-[color:var(--border-faint)] bg-[color:var(--surface-console)] pr-20 text-[color:var(--text-primary)] outline-none transition-[border-color,box-shadow,height,font-size,padding] placeholder:text-[color:var(--text-dim)] focus:border-[color-mix(in_srgb,var(--brand-primary)_40%,transparent)] focus:bg-[color:var(--surface-card)] focus:shadow-[0_0_0_3px_color-mix(in_srgb,var(--brand-primary)_8%,transparent)]",
                hasKeyword ? "h-9 pl-10 text-sm" : "h-11 pl-11 text-[length:var(--text-base)]",
              )}
            />
            {searchText ? (
            ...
            {searchCategoryLabelDescriptors
              ...
              return (
                <button
                  ...
                  className={cn(
                    "inline-flex shrink-0 items-center gap-1 rounded-md px-2.5 py-1 text-[length:var(--text-caption)] transition",
...
function DesktopSearchLandingPanel({
  ...
  return (
    <section className="rounded-[14px] border border-[color:var(--border-faint)] bg-[color:var(--surface-card)] p-3">
...
function DesktopSearchActionButton({
  ...
  const toneClassName =
    tone === "brand"
      ...
      : tone === "danger"
        ...
        : "border-[color:var(--border-faint)] bg-[color:var(--surface-card)] text-[color:var(--text-muted)] hover:bg-[color:var(--surface-console)] hover:text-[color:var(--text-primary)]";
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex items-center justify-center rounded-full border px-2.5 py-1 text-[length:var(--text-eyebrow)] transition",
        desktopSearchChipFocusClassName,
        toneClassName,
        className,
      )}
...
function DesktopSearchOpenCue({
  ...
  const toneClassName =
    tone === "gold"
      ? "border-[color:var(--state-warning-bg)] bg-[color:var(--state-warning-bg)] text-[color:var(--state-warning-text)] group-hover:bg-[color:var(--state-warning-bg)] group-focus-visible:bg-[color:var(--state-warning-bg)]"
      : tone === "teal"
        ? "border-[rgba(15,118,110,0.16)] bg-[rgba(15,118,110,0.08)] text-[color:var(--state-success-text)] group-hover:bg-[rgba(15,118,110,0.12)] group-focus-visible:bg-[rgba(15,118,110,0.12)]"
        : tone === "olive"
          ? "border-[color:var(--state-success-bg)] bg-[color:var(--state-success-bg)] text-[color:var(--state-success-text)] group-hover:bg-[color:var(--state-success-bg)] group-focus-visible:bg-[color:var(--state-success-bg)]"
  ...
  return (
    <span
      className={cn(
        ...
        compact ? "px-2 py-1 text-[10px]" : "px-2.5 py-1 text-[length:var(--text-eyebrow)]",
        toneClassName,
        className,
      )}
    >
...
function DesktopSearchStatusCard({
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 rounded-[var(--radius-sm)] bg-[color:var(--surface-card)] px-3 py-2.5 text-xs leading-6 text-[color:var(--text-secondary)]">
        {description}
      </div>
...
function DesktopSearchScopeCard({
  ...
  const iconToneClassName =
    category === "favorites"
      ? "bg-[color:var(--state-warning-bg)] text-[color:var(--brand-primary)]"
      : category === "moments"
        ? "bg-[color:var(--state-success-bg)] text-[color:var(--state-success-text)]"
        : category === "feed"
          ? "bg-[color:var(--border-subtle)] text-[color:var(--state-success-text)]"
          : "bg-[color-mix(in_srgb,var(--brand-primary)_10%,transparent)] text-[color:var(--state-success-text)]";
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "group flex items-center gap-3 rounded-[var(--radius-sm)] border border-[color:var(--border-faint)] bg-[color:var(--surface-card)] px-3 py-2.5 text-left transition hover:border-[color-mix(in_srgb,var(--brand-primary)_20%,transparent)] hover:bg-[color-mix(in_srgb,var(--brand-primary)_4%,transparent)]",
          ...
          <div className="mt-1.5 flex gap-0.5 overflow-x-auto border-t border-[color:var(--border-faint)] pt-1.5">
            {sectionItems.map((item) => (
              <button
                ...
                className={cn(
                  "inline-flex shrink-0 items-center gap-1 rounded-md px-2 py-0.5 text-[length:var(--text-eyebrow)] transition",
                  desktopSearchChipFocusClassName,
...
function DesktopSearchDrilldownBanner({
  ...
  return (
    <section className="rounded-[18px] border border-[color:var(--state-success-bg)] bg-[linear-gradient(135deg,color-mix(in_srgb,var(--brand-primary)_10%,transparent),color-mix(in_srgb,var(--brand-primary)_4%,transparent)_40%,white)] p-4">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2 text-[length:var(--text-eyebrow)] text-[color:var(--text-dim)]">
            <span className="rounded-full bg-[color:var(--surface-card)] px-2.5 py-1">{t(msg`全部结果`)}</span>
...
function DesktopSearchResultsPanel({
  ...
  return (
    <section
      ref={panelRef}
      className={cn(
        "scroll-mt-36 rounded-[var(--radius-lg)] border bg-[color:var(--surface-console)] p-4 transition-[border-color,box-shadow,transform]",
        highlighted
          ? "border-[color-mix(in_srgb,var(--brand-primary)_24%,transparent)] shadow-[0_20px_44px_color-mix(in_srgb,var(--brand-primary)_10%,transparent)]"
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="rounded-full bg-[color:var(--surface-card)] px-2.5 py-1 text-[10px] text-[color:var(--text-muted)]">
            {countLabel}
          </div>
          {action}
        </div>
...
function DesktopSearchSubsectionPanel({
  ...
  return (
    <section className="rounded-[18px] border border-[color:var(--state-success-bg)] bg-[linear-gradient(180deg,#fbfdfb,white)] px-4 py-4">
...
function DesktopSearchFeatureCard({
  ...
  const toneClassName =
    category === "contacts"
      ? "border-[color:var(--state-success-bg)] bg-[linear-gradient(180deg,#f9fcfa,white)]"
      : category === "favorites"
        ? "border-[color:var(--state-warning-bg)] bg-[linear-gradient(180deg,#fffdf7,white)]"
        : "border-[color:var(--state-success-bg)] bg-[linear-gradient(180deg,#f7fbf9,white)]";
  const badgeClassName =
    category === "contacts"
      ? "bg-[color-mix(in_srgb,var(--brand-primary)_10%,transparent)] text-[color:var(--state-success-text)]"
      : category === "favorites"
        ? "bg-[color:var(--state-warning-bg)] text-[color:var(--state-warning-text)]"
        : "bg-[rgba(15,118,110,0.10)] text-[color:var(--state-success-text)]";
  const actionLabel =
    category === "contacts"
      ? t(msg`查看资料与聊天入口`)
      : category === "favorites"
  ...
  return (
    <button
      ...
      className={cn(
        "group overflow-hidden rounded-[var(--radius-lg)] border p-5 text-left transition hover:-translate-y-0.5 hover:shadow-[0_18px_44px_rgba(15,23,42,0.08)]",
        desktopSearchCardFocusClassName,
    ...
    >
      ...
      <div
        className={cn(
          "mt-4 rounded-[var(--radius-md)] px-4 py-4",
          category === "favorites"
  ...
  return (
    <div className="group/row flex items-center gap-2 rounded-md px-2 py-1.5 hover:bg-[color:var(--surface-console)]">
      ...
      <button
        ...
        onClick={onRemove}
        aria-label={t(msg`移除`)}
        className="shrink-0 rounded p-1 text-[color:var(--text-dim)] opacity-0 transition hover:bg-[color:var(--surface-card)] hover:text-[color:var(--state-danger-text)] group-hover/row:opacity-100 focus:opacity-100"
      >
        <X size={14} />
      </button>
    </div>
...
function DesktopSearchMessageGroupCard({
  ...
  return (
    <section
      className={cn(
        "overflow-hidden rounded-[var(--radius-lg)] border border-[color:var(--state-success-bg)] bg-[linear-gradient(180deg,#fbfdfb,white)] shadow-[0_10px_24px_rgba(15,23,42,0.03)] transition-[border-color,box-shadow]",
    ...
    >
      <button
        ...
        className={cn(
          "group flex w-full items-center gap-3 px-4 py-4 text-left transition hover:bg-[color:var(--surface-card)]",
          desktopSearchRowFocusClassName,
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            <span className="rounded-full bg-[color:var(--surface-card)] px-2 py-0.5 text-[10px] text-[color:var(--text-muted)]">
              {group.header.badge}
            </span>
          </div>
      ...
      <div className="border-t border-[color:var(--border-faint)] bg-[color:var(--state-success-bg)] px-4 py-3">
        <div className="space-y-2">
          {group.messages.map((item) => (
            <button
              ...
              onMouseEnter={() => onSelect(item.id)}
              className={cn(
                "group flex w-full items-start gap-3 rounded-[14px] border border-[color:var(--border-faint)] bg-[color:var(--surface-card)] px-3 py-3 text-left transition hover:bg-[color-mix(in_srgb,var(--brand-primary)_4%,transparent)] hover:shadow-[0_10px_24px_rgba(15,23,42,0.04)]",
                desktopSearchRowFocusClassName,
                selectedResultId === item.id ? desktopSearchSelectedRowClassName : null,
              )}
            >
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-[10px] bg-[color-mix(in_srgb,var(--brand-primary)_10%,transparent)] text-[color:var(--state-success-text)]">
...
function DesktopSearchContentCard({
  ...
  const toneClassName =
    item.category === "moments"
      ? "border-[color:var(--state-success-bg)] bg-[linear-gradient(180deg,#f9fcf7,white)]"
      : "border-[color:var(--state-success-bg)] bg-[linear-gradient(180deg,#f6faf8,white)]";
  const badgeClassName =
    item.category === "moments"
      ? "bg-[color:var(--state-success-bg)] text-[color:var(--state-success-text)]"
      : "bg-[color:var(--border-subtle)] text-[color:var(--state-success-text)]";
  ...
  return (
    <button
      ...
      onMouseEnter={() => onSelect(item.id)}
      className={cn(
        "group overflow-hidden rounded-[var(--radius-lg)] border p-5 text-left transition hover:-translate-y-0.5 hover:shadow-[0_20px_48px_rgba(15,23,42,0.08)]",
        desktopSearchCardFocusClassName,
        selected ? desktopSearchSelectedCardClassName : null,
        toneClassName,
      )}
    >
      ...
      <div className="mt-4 rounded-[var(--radius-md)] bg-[color:var(--surface-console)] px-4 py-4">
...
function DesktopSearchResultRow({
  ...
  return (
    <button
      ...
      onMouseEnter={() => onSelect(item.id)}
      className={cn(
        "group flex w-full items-center gap-3 rounded-[var(--radius-md)] border border-[color:var(--border-faint)] bg-[color:var(--surface-card)] px-3.5 py-3 text-left transition hover:bg-[color-mix(in_srgb,var(--brand-primary)_4%,transparent)] hover:shadow-[0_10px_24px_rgba(15,23,42,0.04)]",
        desktopSearchRowFocusClassName,
