    ...
    <button
      ...
      className={
        layout === "mobile"
          ...
          : "flex w-full items-start gap-3 rounded-[20px] border border-[color:var(--border-faint)] bg-[color:var(--surface-card)] px-4 py-4 text-left shadow-[var(--shadow-soft)] transition hover:border-[rgba(245,158,11,0.16)] hover:bg-[color:var(--surface-console)]"
      }
    >
      <AvatarChip
