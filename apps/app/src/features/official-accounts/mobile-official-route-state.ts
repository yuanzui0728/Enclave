...
export type MobileOfficialRouteState = {
  returnPath?: string;
  returnHash?: string;
};
...
export function parseMobileOfficialRouteState(
  hash: string,
): MobileOfficialRouteState {
...
export function buildMobileOfficialRouteHash(
  state: MobileOfficialRouteState,
) {
