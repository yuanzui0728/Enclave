...
export function ManagementPermissionsDetailScreen({
  ...
  return (
    <div className="px-3 py-3">
      <div className="flex items-center gap-3 rounded-[12px] bg-[color:var(--surface-card)] px-3 py-3 shadow-[0_1px_0_rgba(180,130,20,0.04)]">
      ...
      <ul className="mt-3 overflow-hidden rounded-[12px] bg-[color:var(--surface-card)] shadow-[0_1px_0_rgba(180,130,20,0.04)]">
    ...
    >
      ...
      >
        ...
        >
          <span
            className={cn(
              "inline-block h-[22px] w-[22px] transform rounded-full bg-[color:var(--surface-card)] shadow transition-transform",
