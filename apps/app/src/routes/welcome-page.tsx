          ...
          >
            <Button
              ...
              className={`flex-1 rounded-xl shadow-none ${
                authMode === "login"
                  ? "bg-[color:var(--surface-card)] text-[color:var(--text-primary)] hover:bg-[color:var(--surface-card)]"
    ...
    return (
      <AppPage className="relative flex min-h-full items-center justify-center overflow-hidden p-6 sm:p-8">
        ...
        <div className="relative z-10 w-full max-w-3xl">
          ...
          <AppSection className="relative mx-auto w-full max-w-xl rounded-[var(--radius-xl)] border-[color:var(--border-faint)]/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(255,248,235,0.94))] px-7 py-8 shadow-[0_28px_72px_rgba(60, 40, 110, 0.22)] backdrop-blur-2xl">
            <div className="inline-flex rounded-full border border-[color:var(--state-warning-bg)] bg-[color:var(--surface-card)]/78 px-3 py-1 text-[length:var(--text-eyebrow)] uppercase tracking-[0.32em] text-[color:var(--brand-primary)]">
