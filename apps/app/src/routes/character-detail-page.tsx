...
export function CharacterDetailPage() {
  ...
  return (
    ...
    >
      <header
        className={cn(
          "z-20 border-b border-[color:var(--border-faint)] bg-[color:var(--surface-overlay)] px-2 py-2 backdrop-blur-xl",
      ...
      {!isDesktopLayout && character ? (
        ...
        <div className="shrink-0 border-t border-[color:var(--border-faint)] bg-[color:var(--surface-overlay)] px-4 pb-[calc(env(safe-area-inset-bottom,0px)+0.75rem)] pt-3 backdrop-blur-xl">
          <div
            className={cn(
              "grid gap-2",
              isFriend ? "grid-cols-2" : "grid-cols-1",
...
function MobileCharacterErrorNotice({
  ...
  return (
    <InlineNotice
      tone="danger"
      className="rounded-[var(--radius-sm)] border border-[color:var(--border-danger)] bg-[color:var(--state-danger-bg)] px-2.5 py-1.5 text-[10px] leading-4 shadow-none"
    >
      {action ? (
