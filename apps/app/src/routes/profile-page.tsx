    ...
    <AppPage className="space-y-0 bg-[color:var(--bg-canvas)] px-0 py-0">
      ...
      <div className="pb-8">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-1.5">
              ...
              {username?.trim() ? (
                ...
                <div className="shrink-0 whitespace-nowrap rounded-full bg-[color:var(--brand-primary)]/8 px-1.5 py-0.5 text-[10px] font-medium tracking-[0.04em] text-[color:var(--brand-primary)]">
                  {t(msg`世界主人`)}
                </div>
              ) : null}
            </div>
        ...
        <ProfileEntryGroup className="mt-1">
          <ProfileEntry
            icon={Settings}
            iconClassName="bg-[color:var(--brand-primary)]/10 text-[color:var(--brand-primary)]"
            label={t(msg`设置`)}
            to={settingsPath}
          />
        </ProfileEntryGroup>
