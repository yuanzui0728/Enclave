        ...
        rightActions={
          <span className="relative inline-flex">
            ...
            {hasMomentDraft ? (
              ...
              <span
                aria-hidden
                className="pointer-events-none absolute right-1 top-1 inline-block h-1.5 w-1.5 rounded-full bg-[color:var(--state-danger-solid)] ring-2 ring-[color:var(--border-faint)]"
              />
            ) : null}
          </span>
        }
