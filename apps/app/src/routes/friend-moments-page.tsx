...
export function FriendMomentsPage() {
  ...
  if (!isDesktopLayout) {
    return (
      <AppPage className="flex min-h-full items-center justify-center bg-[color:var(--surface-secondary)] px-4 py-8">
        <LoadingBlock
          label={t(msg`正在切换到手机端角色朋友圈...`)}
          className="w-full max-w-[360px] rounded-[var(--radius-xl)] border-[color:var(--border-faint)] bg-[color:var(--surface-card)] bg-[image:var(--surface-card-gradient)] py-8 shadow-[var(--shadow-section)]"
        />
      </AppPage>
    );
  }
  ...
  if (!character && (characterQuery.isLoading || friendsQuery.isLoading)) {
    return (
      <div className="flex h-full items-center justify-center bg-[color:var(--surface-secondary)] px-6">
        <LoadingBlock
          label={t(msg`正在读取角色朋友圈...`)}
          className="w-full max-w-[420px] rounded-[var(--radius-xl)] border-[color:var(--border-faint)] bg-[color:var(--surface-card)] bg-[image:var(--surface-card-gradient)] py-10 shadow-[var(--shadow-section)]"
        />
      </div>
    );
  }
  ...
  if (!character) {
    return (
      <div className="flex h-full items-center justify-center bg-[color:var(--surface-secondary)] px-6">
        <div className="w-full max-w-[480px] rounded-[var(--radius-xl)] border border-[color:var(--border-faint)] bg-[color:var(--surface-card)] bg-[image:var(--surface-card-gradient)] p-6 shadow-[var(--shadow-section)]">
