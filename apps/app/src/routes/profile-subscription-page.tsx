            ...
            <div className="mt-5 flex flex-col gap-4 sm:flex-row sm:items-start">
              <div className="flex-1 space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <Button
                    variant="primary"
                    // 走查新 R3：之前只 hover:bg-，移动端 tap 时没视觉按压反馈
                    // —— 用户敲一下「复制链接」没动静再敲一次就发了 2 次 handleCopy
                    // → toast 闪 2 帧（feedback 自清 timer 互踩）+ writeClipboardText
                    // bridge 也跑 2 次。给 active:opacity-90 比 hover 更深一档的绿
                    // 让按下瞬间能看到颜色变化，跟 wechat 的"复制成功"按钮按压反馈一致。
                    className="rounded-full bg-[color:var(--brand-primary)] text-[color:var(--text-on-brand)] shadow-none hover:bg-[color:var(--brand-primary)] active:opacity-90"
                    onClick={() =>
                      void handleCopy(shareUrl, t(msg`已复制邀请链接。`))
                    }
                  >
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <Button
                        ...
                        className="mt-3 rounded-full bg-[color:var(--brand-primary)] text-[color:var(--text-on-brand)] shadow-none hover:bg-[color:var(--brand-primary)] active:opacity-90"
